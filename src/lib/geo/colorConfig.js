...
const chartPalettes = {
 ...
 multiPalette: [
  ...
  headerCards: {
    revenue: 'bg-gradient-to-r from-emerald-700 to-emerald-500',
    taxes: 'bg-gradient-to-r from-emerald-700 to-emerald-500',
    commission: 'bg-gradient-to-r from-emerald-700 to-emerald-500',
    net: 'bg-gradient-to-r from-emerald-700 to-emerald-500',


    passengers: 'bg-gradient-to-r from-sky-700 to-sky-500',
    flights: 'bg-gradient-to-r from-sky-700 to-sky-500',
    reservations:  'bg-gradient-to-r from-sky-700 to-sky-500',
    agencies: 'bg-gradient-to-r from-sky-700 to-sky-500',
